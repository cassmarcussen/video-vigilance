...
function createAudioTranscription() {
  ...
  fetch('/audio-effect', {
    ...
    titleElement.innerText = 'The effect of the video file generated by Perspective API: ';

    const textElement = document.createElement('p');
    textElement.innerText = effectObj;

    effectDiv.appendChild(titleElement);
    effectDiv.appendChild(textElement);
